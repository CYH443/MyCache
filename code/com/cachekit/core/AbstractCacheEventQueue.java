...
public abstract class AbstractCacheEventQueue<K, V> implements ICacheEventQueue<K, V> {
    ...
    // 线性组件为CacheKitWrapper，磁盘组件为DiskCacheListener
    ...
    protected class PutEvent extends AbstractCacheEvent
    {
        ...
        public String toString()
        {
            StringBuilder sb = new StringBuilder("PutEvent for key: ").append(ice.getKey()).append(" value: ").append(ice.getVal());
            return sb.toString();
        }
    }
